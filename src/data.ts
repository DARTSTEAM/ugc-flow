...
export const CAMPANAS_MOCK: Campana[] = [
  {
    id: 'camp-001',
    nombre: 'Popeyes - Menú Verano 2025',
    marca: 'Popeyes',
    estado: 'Activa',
    descripcion: 'Campaña de UGC para comunicar el nuevo menú de verano de Popeyes. Buscamos creadores auténticos amantes del pollo crujiente estilo sureño.',
    fechaInicio: '2025-06-01',
    fechaFin: '2025-08-31',
    objetivo: 10,
    ugcs: [
      { ugcId: 'ugc-001', estado: 'Calificado', fechaEnvio: '2025-06-02', fechaRespuesta: '2025-06-03' },
      { ugcId: 'ugc-002', estado: 'Respondió', fechaEnvio: '2025-06-02', fechaRespuesta: '2025-06-04' },
      { ugcId: 'ugc-003', estado: 'Enviado', fechaEnvio: '2025-06-03', fechaRespuesta: null },
      { ugcId: 'ugc-005', estado: 'No aplica', fechaEnvio: '2025-06-01', fechaRespuesta: '2025-06-02' },
      { ugcId: 'ugc-006', estado: 'Calificado', fechaEnvio: '2025-06-02', fechaRespuesta: '2025-06-03' },
      { ugcId: 'ugc-008', estado: 'Pendiente', fechaEnvio: '2025-06-03', fechaRespuesta: null },
      { ugcId: 'ugc-012', estado: 'Calificado', fechaEnvio: '2025-06-01', fechaRespuesta: '2025-06-02' },
    ],
  },
  {
    id: 'camp-002',
    nombre: 'Don Belisario - Día del Pollo',
    marca: 'Don Belisario',
    estado: 'Borrador',
    descripcion: 'Campaña de UGC para el Día del Pollo de Don Belisario. Pollos a la brasa y comida peruana auténtica. Buscamos creadores amantes de la gastronomía peruana.',
    fechaInicio: '2025-07-01',
    fechaFin: '2025-08-15',
    objetivo: 6,
    ugcs: [
      { ugcId: 'ugc-001', estado: 'Calificado', fechaEnvio: '2025-07-02', fechaRespuesta: '2025-07-03' },
      { ugcId: 'ugc-003', estado: 'Calificado', fechaEnvio: '2025-07-02', fechaRespuesta: '2025-07-04' },
    ],
  },
  {
    id: 'camp-003',
    nombre: "Dunkin' - Colección Otoño",
    marca: "Dunkin'",
    estado: 'Pausada',
    descripcion: "Campaña de UGC para la colección de otoño de Dunkin'. Donuts de temporada y cafetería especial. Creadores lifestyle y food lovers.",
    fechaInicio: '2025-04-01',
    fechaFin: '2025-06-30',
    objetivo: 9,
    ugcs: [
      { ugcId: 'ugc-002', estado: 'Calificado', fechaEnvio: '2025-04-02', fechaRespuesta: '2025-04-03' },
      { ugcId: 'ugc-005', estado: 'Respondió', fechaEnvio: '2025-04-02', fechaRespuesta: '2025-04-04' },
      { ugcId: 'ugc-011', estado: 'No aplica', fechaEnvio: '2025-04-03', fechaRespuesta: '2025-04-05' },
    ],
  },
  {
    id: 'camp-004',
    nombre: "Papa John's - Black Friday 2024",
    marca: "Papa John's",
    estado: 'Cerrada',
    descripcion: "Campaña de UGC para Black Friday 2024 de Papa John's. Alta rotación de contenido para comunicar las promociones de pizzas.",
  ...
  {
    id: 'camp-005',
    nombre: 'Bembos - Burger Fest 2025',
    marca: 'Bembos',
    estado: 'Activa',
    descripcion: 'Campaña de UGC para el festival de hamburguesas Burger Fest 2025 de Bembos. Creadores food y lifestyle apasionados por las mejores hamburguesas.',
    fechaInicio: '2025-05-15',
    fechaFin: '2025-07-15',
    objetivo: 8,
    ugcs: [
      { ugcId: 'ugc-007', estado: 'Calificado', fechaEnvio: '2025-05-16', fechaRespuesta: '2025-05-17' },
      { ugcId: 'ugc-009', estado: 'Calificado', fechaEnvio: '2025-05-16', fechaRespuesta: '2025-05-18' },
      { ugcId: 'ugc-010', estado: 'Respondió', fechaEnvio: '2025-05-17', fechaRespuesta: '2025-05-19' },
      { ugcId: 'ugc-011', estado: 'Enviado', fechaEnvio: '2025-05-18', fechaRespuesta: null },
    ],
  },
  {
    id: 'camp-006',
    nombre: 'Bembos - Aniversario 35 Años',
    marca: 'Bembos',
    estado: 'Borrador',
    descripcion: 'Campaña especial de UGC para el 35 aniversario de Bembos. Celebramos 35 años de las mejores hamburguesas con creadores apasionados por la marca.',
    fechaInicio: '2025-08-01',
    fechaFin: '2025-09-30',
    objetivo: 12,
    ugcs: [
      { ugcId: 'ugc-007', estado: 'Calificado', fechaEnvio: '2025-08-02', fechaRespuesta: '2025-08-03' },
    ],
  },
  {
    id: 'camp-007',
    nombre: 'Don Belisario - Delivery Exprés',
    marca: 'Don Belisario',
    estado: 'Pausada',
    descripcion: 'Campaña de UGC para el servicio de delivery exprés de Don Belisario. Creadores que disfrutan de la comida peruana desde casa.',
    fechaInicio: '2025-03-01',
    fechaFin: '2025-05-31',
    objetivo: 7,
    ugcs: [
      { ugcId: 'ugc-006', estado: 'Calificado', fechaEnvio: '2025-03-02', fechaRespuesta: '2025-03-03' },
      { ugcId: 'ugc-009', estado: 'Respondió', fechaEnvio: '2025-03-03', fechaRespuesta: '2025-03-05' },
      { ugcId: 'ugc-011', estado: 'Pendiente', fechaEnvio: '2025-03-04', fechaRespuesta: null },
    ],
  },
  {
    id: 'camp-008',
    nombre: 'Chinawok - Año Nuevo Chino',
    marca: 'Chinawok',
    estado: 'Cerrada',
    descripcion: 'Campaña de UGC para celebrar el Año Nuevo Chino con Chinawok. Contenido auténtico sobre la tradición culinaria oriental.',
    fechaInicio: '2025-01-15',
    fechaFin: '2025-02-15',
    objetivo: 8,
    ugcs: [
      { ugcId: 'ugc-001', estado: 'Calificado', fechaEnvio: '2025-01-16', fechaRespuesta: '2025-01-17' },
      { ugcId: 'ugc-002', estado: 'Calificado', fechaEnvio: '2025-01-16', fechaRespuesta: '2025-01-18' },
      { ugcId: 'ugc-004', estado: 'Respondió', fechaEnvio: '2025-01-17', fechaRespuesta: '2025-01-19' },
      { ugcId: 'ugc-005', estado: 'No aplica', fechaEnvio: '2025-01-17', fechaRespuesta: '2025-01-18' },
      { ugcId: 'ugc-007', estado: 'Calificado', fechaEnvio: '2025-01-15', fechaRespuesta: '2025-01-16' },
      { ugcId: 'ugc-010', estado: 'Enviado', fechaEnvio: '2025-01-18', fechaRespuesta: null },
    ],
  },
  {
    id: 'camp-009',
    nombre: 'Chinawok - Festival Lunar',
    marca: 'Chinawok',
    estado: 'Activa',
    descripcion: 'Campaña de UGC para el Festival Lunar de Chinawok. Buscamos creadores que amen la comida oriental y quieran compartir la experiencia.',
    fechaInicio: '2025-05-20',
    fechaFin: '2025-07-20',
    objetivo: 7,
    ugcs: [
      { ugcId: 'ugc-004', estado: 'Calificado', fechaEnvio: '2025-05-21', fechaRespuesta: '2025-05-22' },
      { ugcId: 'ugc-006', estado: 'Enviado', fechaEnvio: '2025-05-22', fechaRespuesta: null },
      { ugcId: 'ugc-008', estado: 'Pendiente', fechaEnvio: '2025-05-23', fechaRespuesta: null },
    ],
  },
];
