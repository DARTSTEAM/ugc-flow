...
export const CAMPANAS_MOCK: Campana[] = [
  ...
  {
    id: 'camp-002',
    nombre: 'Campaña Bembos Q2',
    marca: 'Bembos',
    estado: 'Borrador',
    descripcion: 'Campaña de UGC para el lanzamiento del nuevo menú de Bembos. Creadores lifestyle y food.',
  ...
  {
    id: 'camp-003',
    nombre: 'Papa Johns Black Friday 2024',
    marca: 'Papa Johns',
    estado: 'Cerrada',
    descripcion: 'Campaña de UGC para Black Friday 2024 de Papa Johns. Alta rotación de contenido para comunicar promociones.',
